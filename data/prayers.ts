...
Szabadíts ki engem ellenségeim kezéből, Uram, oltalmadhoz menekültem! Taníts meg akaratodat cselekednem, mert te vagy az én Istenem!
...
Sok kísértés szorongat engem; üdvösséget keresve Hozzád menekedek; óh Igének Anyja, Szüz, szabadíts meg engem a megpróbáltatásoktól és a csapásoktól.
...
Méltasd beteg testemet és lelkemet isteni meglátogatásra, és a Te gondviselésedre, egyedülvaló Istenanyja, mert jóságos vagy, és a Jónak Szülője.`
      },
      {
...
Könyörgök Hozzád, óh Szűz, oszlasd el lelkem zavarát, és csüggedésem háborgását; mert Te szülted, Isteni Mennyasszony, Krisztust, a béke Fejedelmét, egyedüli Tisztaságos.
...
Szabadíts meg a veszedelmektől a Te szolgáidat, Istennek Szülője, mert Isten után Hozzád menekedünk mindnyájan, mint rendíthetetlen védőfalunkhoz és oltalmunkhoz.
...
`,
      },
      {
        ...
        text: `Forró pártfogónk, bevehetetlen védőfalunk, könyörületesség forrása, világnak menedéke, buzgón kiáltunk Hozzád: Istenszülő Nagyasszonyunk, siess, válts ki bennünket a veszedelmekből, mert Te vagy a mi egyedüli gyors oltalmazónk.`,
      },
      {
...
Te vagy a mi reménységünk és erősségünk, üdvösségünk rendíthetetlen védőfala, óh Legmagasztaltabb, ezért megszabadulunk minden nyomorúságtól.`,
      },
      {
...
Oszlasd el vétkeimnek sötétségét, Isteni Menyaszszony, a te ragyogásod világosságával, mert Te szülted az isteni és örökkévalóság-előtti Világosságot.
...
A Te Fiad és Istened önmagát adván át a halálnak, megszabadította a haláltól és a romlástól a halál és romlás által fogva tartott természetemet. Engeszteld hát Öt, óh Szűz, hogy szabadítson meg engem ellenségeim gonoszságától.
...
Ime, betegen fekszem ágyamban és nincs gyógyulás testem számára Rajtad kívül, Aki az Istent, a világ Megváltóját, a betegségek feloldóját szülted; Hozzád könyörgök, jóságos, emelj föl engem a pusztító betegségekből.

Szabadíts meg a veszedelmektől a Te szolgáidat, Istennek Szülője, mert Isten után Hozzád menekedünk mindnyájan, mint rendíthetetlen védőfalunkhoz és oltalmunkhoz.

Oh Tisztaságos, aki a végső napokban kifejezhetetlen módon szülted ige által az Igét, engeszteld Öt, hiszen anyai bizodalmad van Öhozzá.
`,
      },
      {
...
A Szent Lélek által minden lélek megelevenedik, és megtisztulva fölemelkedik; tündököl a Háromságos Egység által, szent titokzatossággal.
...
Vers: Halljad, leány, és lássad, és hajtsd ide füledet! Felejtsd el népedet és atyádnak házát, és megkívánja a Király a te szépségedet!
...
`,
      },
      {
        ...
        text: `Ne bízz engem emberi oltalomra, Szentséges Nagyasszonyunk, hanem fogadd el szolgádnak könyörgését. Nyomorúságba jutottam, nem bírom elviselni a démonok nyilait, nincs hely, ahová menekülhetnék én nyomorult; mindenfelől támadnak, és nincs vigasztalásom Rajtad kívül. Világ Nagyaszszonya, hívők reménysége és oltalma, ne vesd el könyörgésemet, hanem tedd azt, ami javamra szolgál!
`,
      },
      {
        heading: "2. hang",
...
Midőn a mi üdvösségünk művét végbe akartad vinni óh Üdvözítő, a Szűz méhében lakoztál, kit a világ pártfogójává tettél. Áldott vagy, Atyáinknak Istene.

${MOST_HOLY}

Tisztaságos Anya, Te szülted azt, aki az irgalmat akarja, esedezzél hát hozzá, hogy tisztítsa meg a vétkektől és a lélek szennyfoltjaitól azokat, akik hittel kiáltják: Áldott vagy, Atyáinknak Istene.

${GLORY}

Az üdvösség kincsesházaként és a romolhatatlanság forrásaként, a biztonság bástyájaként és a bűnbánat kapujaként mutattad fel Szülődet azoknak, akik ezt kiáltják: Áldott vagy, Atyáinknak Istene.
...
Ne vesd el, Szúz, azokat, akik segítségért esedeznek Hozzád, akik dicsérnek, ó Hajadon, és magasztalnak mindörökké.
...
Lelkem betegségeit és testem fájdalmait meggyógyítod, ó Szűz, hogy dicsőítselek téged, kegyelembe fogadott.
...
Révpartja, védelme és rendíthetetlen védőfala, menedéke, oltalma és örvendezése légy, óh Szűz, a Hozzád menekülőknek.
...
`,
      },
      {
        ...
        text: `Valóban méltó boldognak nevezni Téged, Istennek Szülője, az örökké boldogságost és feddhetetlent, és a mi Istenünknek Anyját. Aki a Keruboknál tiszteltebb és a Szeráfoknál hasonlíthatatlanul dicsőbb vagy, aki az Isteni Igét sérületlenül szülted, Istennek valóságos Szülője, Téged magasztalunk.

Aki a mennyeknél is magasztosabb és a napsugaraknál is tisztább, aki megszabadított bennünket az átoktól, a világ Nagyasszonyát énekekkel magasztaljuk. Bűneim sokasága miatt beteg a testem és beteg a lelkem is; Tehozzád menekedem, kegyelembe fogadott, reményvesztettek Reménysége, Te segíts rajtam.
...
Némák az istentelenek ajkai, akik nem hódolnak a legszentebb Lukács apostol által festett tiszteletreméltó ikonod, az Odigitria előtt.

Angyalok összes serege, az Úr Előhírnöke, tizenkét Apostol, és minden szentek, Isten Szülőjével együtt járjatok közre üdvözülésünkért.
